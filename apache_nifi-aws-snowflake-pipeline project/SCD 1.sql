...
from
    customer;
-- truncate customer;
    -- In snowflake we use javascript for the stored procedures
...
call pdr_scd_demo();
create
    or replace task tsk_scd_raw warehouse = COMPUTE_WH schedule = '1 minute' ERROR_ON_NONDETERMINISTIC_MERGE = FALSE
    AS call pdr_scd_demo() show tasks;
