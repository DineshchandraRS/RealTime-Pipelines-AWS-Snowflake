...
s3_path = "s3://spotify-etl-project-dinesh/raw_data/to_processed/"
...
def write_to_s3(df, path_suffix, format_type = "csv"):
    ...
    glueContext.write_dynamic_frame.from_options(
        frame=dynamic_frame,
        connection_type="s3",
        connection_options={"path": f"s3://spotify-etl-project-dinesh/transformed_data/{path_suffix}/"},
        format=format_type,
    )
...
bucket_name = "spotify-etl-project-dinesh"
